  ...
  return (
    <div className="flex gap-4">
      <div className="relative group">
        ...
        <div className="relative bg-linear-to-br from-slate-700 via-slate-600 to-slate-700 backdrop-blur-xl border border-emerald-500/30 rounded-2xl px-6 py-3 flex items-center gap-3">
      ...
      <div className="relative group">
        ...
        <div className="relative bg-linear-to-br from-slate-700 via-slate-600 to-slate-700 backdrop-blur-xl border border-rose-500/30 rounded-2xl px-6 py-3 flex items-center gap-3">
