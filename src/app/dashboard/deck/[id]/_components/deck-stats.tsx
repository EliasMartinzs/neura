      ...
      {expandedStats && (
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          <div className="relative group cursor-pointer">
            <div className="relative border dark:bg-none bg-linear-to-br from-slate-700 via-slate-600 to-slate-700 text-white shadow rounded-2xl p-6 transform transition-transform duration-300 group-hover:scale-105">
              <div className="flex items-start justify-between mb-4">
                <div className="p-3 bg-linear-to-br from-blue-500 to-cyan-500 rounded-xl group-hover:scale-110 transition-transform">
          ...
          <div className="relative group cursor-pointer">
            <div className="relative border dark:bg-none bg-linear-to-br from-slate-700 via-slate-600 to-slate-700 text-white shadow rounded-2xl p-6 transform transition-transform duration-300 group-hover:scale-105">
              <div className="flex items-start justify-between mb-4">
                <div className="p-3 bg-linear-to-br from-purple-500 to-pink-500 rounded-xl group-hover:scale-110 transition-transform">
                  <Activity className="w-7 h-7 text-purple-700" />
                </div>
                <Trophy className="w-5 h-5 text-purple-200 group-hover:rotate-12 transition-transform" />
              </div>
              <div className="text-5xl font-black mb-2 ">{reviewCount}</div>
              <div className="text-purple-200 text-sm font-semibold uppercase tracking-wide">
                Revisões Feitas
              </div>
          ...
          <div className="relative group cursor-pointer">
            <div className="relative border dark:bg-none bg-linear-to-br from-slate-700 via-slate-600 to-slate-700 text-white shadow rounded-2xl p-6 transform transition-transform duration-300 group-hover:scale-105">
              <div className="flex items-start justify-between mb-4">
                <div className="p-3 bg-linear-to-br from-green-500 to-emerald-500 rounded-xl group-hover:scale-110 transition-transform">
                  <TrendingUp className="w-7 h-7 text-green-700" />
                </div>
                <Award className="w-5 h-5 text-green-200 group-hover:scale-110 transition-transform" />
              </div>
          ...
          <div className="relative group cursor-pointer">
            <div className="relative border dark:bg-none bg-linear-to-br from-slate-700 via-slate-600 to-slate-700 text-white shadow rounded-2xl p-6 transform transition-transform duration-300 group-hover:scale-105">
              <div className="flex items-start justify-between mb-4">
                <div className="p-3 bg-linear-to-br from-yellow-500 to-orange-500 rounded-xl group-hover:scale-110 transition-transform">
                  <Brain className="w-7 h-7 text-yellow-700" />
                </div>
